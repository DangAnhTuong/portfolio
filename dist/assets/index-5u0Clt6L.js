 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Od;function b0(){if(Od)return k;Od=1;var z=Symbol.for("react.transitional.element"),R=Symbol.for("react.portal"),D=Symbol.for("react.fragment"),m=Symbol.for("react.strict_mode"),Y=Symbol.for("react.profiler"),C=Symbol.for("react.consumer"),$=Symbol.for("react.context"),he=Symbol.for("react.forward_ref"),q=Symbol.for("react.suspense"),N=Symbol.for("react.memo"),Z=Symbol.for("react.lazy"),G=Symbol.for("react.activity"),ue=Symbol.iterator;function Fe(c){return c===null||typeof c!="object"?null:(c=ue&&c[ue]||c["@@iterator"],typeof c=="function"?c:null)}var Ze={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},Ge=Object.assign,se={};function Ie(c,g,M){this.props=c,this.context=g,this.refs=se,this.updater=M||Ze}Ie.prototype.isReactComponent={},Ie.prototype.setState=function(c,g){if(typeof c!="object"&&typeof c!="function"&&c!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,c,g,"setState")},Ie.prototype.forceUpdate=function(c){this.updater.enqueueForceUpdate(this,c,"forceUpdate")};function Lt(){}Lt.prototype=Ie.prototype;function Ee(c,g,M){this.props=c,this.context=g,this.refs=se,this.updater=M||Ze}var lt=Ee.prototype=new Lt;lt.constructor=Ee,Ge(lt,Ie.prototype),lt.isPureReactComponent=!0;var St=Array.isArray;function ke(){}var F={H:null,A:null,T:null,S:null},Ke=Object.prototype.hasOwnProperty;function zt(c,g,M){var A=M.ref;return{$$typeof:z,type:c,key:g,ref:A!==void 0?A:null,props:M}}function rl(c,g){return zt(c.type,g,c.props)}function Mt(c){return typeof c=="object"&&c!==null&&c.$$typeof===z}function Je(c){var g={"=":"=0",":":"=2"};return"$"+c.replace(/[=:]/g,function(M){return g[M]})}var Zt=/\/+/g;function Tt(c,g){return typeof c=="object"&&c!==null&&c.key!=null?Je(""+c.key):g.toString(36)}function Pe(c){switch(c.status){case"fulfilled":return c.value;case"rejected":throw c.reason;default:switch(typeof c.status=="string"?c.then(ke,ke):(c.status="pending",c.then(function(g){c.status==="pending"&&(c.status="fulfilled",c.value=g)},function(g){c.status==="pending"&&(c.status="rejected",c.reason=g)})),c.status){case"fulfilled":return c.value;case"rejected":throw c.reason}}throw c}function S(c,g,M,A,E){var U=typeof c;(U==="undefined"||U==="boolean")&&(c=null);var _=!1;if(c===null)_=!0;else switch(U){case"bigint":case"string":case"number":_=!0;break;case"object":switch(c.$$typeof){case z:case R:_=!0;break;case Z:return _=c._init,S(_(c._payload),g,M,A,E)}}if(_)return E=E(c),_=A===""?"."+Tt(c,0):A,St(E)?(M="",_!=null&&(M=_.replace(Zt,"$&/")+"/"),S(E,g,M,"",function(ge){return ge})):E!=null&&(Mt(E)&&(E=rl(E,M+(E.key==null||c&&c.key===E.key?"":(""+E.key).replace(Zt,"$&/")+"/")+_)),g.push(E)),1;_=0;var w=A===""?".":A+":";if(St(c))for(var V=0;V<c.length;V++)A=c[V],U=w+Tt(A,V),_+=S(A,g,M,U,E);else if(V=Fe(c),typeof V=="function")for(c=V.call(c),V=0;!(A=c.next()).done;)A=A.value,U=w+Tt(A,V++),_+=S(A,g,M,U,E);else if(U==="object"){if(typeof c.then=="function")return S(Pe(c),g,M,A,E);throw g=String(c),Error("Objects are not valid as a React child (found: "+(g==="[object Object]"?"object with keys {"+Object.keys(c).join(", ")+"}":g)+"). If you meant to render a collection of children, use an array instead.")}return _}function O(c,g,M){if(c==null)return c;var A=[],E=0;return S(c,A,"","",function(U){return g.call(M,U,E++)}),A}function X(c){if(c._status===-1){var g=c._result;g=g(),g.then(function(M){(c._status===0||c._status===-1)&&(c._status=1,c._result=M)},function(M){(c._status===0||c._status===-1)&&(c._status=2,c._result=M)}),c._status===-1&&(c._status=0,c._result=g)}if(c._status===1)return c._result.default;throw c._result}var re=typeof reportError=="function"?reportError:function(c){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var g=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof c=="object"&&c!==null&&typeof c.message=="string"?String(c.message):String(c),error:c});if(!window.dispatchEvent(g))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",c);return}console.error(c)},h={map:O,forEach:function(c,g,M){O(c,function(){g.apply(this,arguments)},M)},count:function(c){var g=0;return O(c,function(){g++}),g},toArray:function(c){return O(c,function(g){return g})||[]},only:function(c){if(!Mt(c))throw Error("React.Children.only expected to receive a single React element child.");return c}};return k.Activity=G,k.Children=h,k.Component=Ie,k.Fragment=D,k.Profiler=Y,k.PureComponent=Ee,k.StrictMode=m,k.Suspense=q,k.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=F,k.__COMPILER_RUNTIME={__proto__:null,c:function(c){return F.H.useMemoCache(c)}},k.cache=function(c){return function(){return c.apply(null,arguments)}},k.cacheSignal=function(){return null},k.cloneElement=function(c,g,M){if(c==null)throw Error("The argument must be a React element, but you passed "+c+".");var A=Ge({},c.props),E=c.key;if(g!=null)for(U in g.key!==void 0&&(E=""+g.key),g)!Ke.call(g,U)||U==="key"||U==="__self"||U==="__source"||U==="ref"&&g.ref===void 0||(A[U]=g[U]);var U=arguments.length-2;if(U===1)A.children=M;else if(1<U){for(var _=Array(U),w=0;w<U;w++)_[w]=arguments[w+2];A.children=_}return zt(c.type,E,A)},k.createContext=function(c){return c={$$typeof:$,_currentValue:c,_currentValue2:c,_threadCount:0,Provider:null,Consumer:null},c.Provider=c,c.Consumer={$$typeof:C,_context:c},c},k.createElement=function(c,g,M){var A,E={},U=null;if(g!=null)for(A in g.key!==void 0&&(U=""+g.key),g)Ke.call(g,A)&&A!=="key"&&A!=="__self"&&A!=="__source"&&(E[A]=g[A]);var _=arguments.length-2;if(_===1)E.children=M;else if(1<_){for(var w=Array(_),V=0;V<_;V++)w[V]=arguments[V+2];E.children=w}if(c&&c.defaultProps)for(A in _=c.defaultProps,_)E[A]===void 0&&(E[A]=_[A]);return zt(c,U,E)},k.createRef=function(){return{current:null}},k.forwardRef=function(c){return{$$typeof:he,render:c}},k.isValidElement=Mt,k.lazy=function(c){return{$$typeof:Z,_payload:{_status:-1,_result:c},_init:X}},k.memo=function(c,g){return{$$typeof:N,type:c,compare:g===void 0?null:g}},k.startTransition=function(c){var g=F.T,M={};F.T=M;try{var A=c(),E=F.S;E!==null&&E(M,A),typeof A=="object"&&A!==null&&typeof A.then=="function"&&A.then(ke,re)}catch(U){re(U)}finally{g!==null&&M.types!==null&&(g.types=M.types),F.T=g}},k.unstable_useCacheRefresh=function(){return F.H.useCacheRefresh()},k.use=function(c){return F.H.use(c)},k.useActionState=function(c,g,M){return F.H.useActionState(c,g,M)},k.useCallback=function(c,g){return F.H.useCallback(c,g)},k.useContext=function(c){return F.H.useContext(c)},k.useDebugValue=function(){},k.useDeferredValue=function(c,g){return F.H.useDeferredValue(c,g)},k.useEffect=function(c,g){return F.H.useEffect(c,g)},k.useEffectEvent=function(c){return F.H.useEffectEvent(c)},k.useId=function(){return F.H.useId()},k.useImperativeHandle=function(c,g,M){return F.H.useImperativeHandle(c,g,M)},k.useInsertionEffect=function(c,g){return F.H.useInsertionEffect(c,g)},k.useLayoutEffect=function(c,g){return F.H.useLayoutEffect(c,g)},k.useMemo=function(c,g){return F.H.useMemo(c,g)},k.useOptimistic=function(c,g){return F.H.useOptimistic(c,g)},k.useReducer=function(c,g,M){return F.H.useReducer(c,g,M)},k.useRef=function(c){return F.H.useRef(c)},k.useState=function(c){return F.H.useState(c)},k.useSyncExternalStore=function(c,g,M){return F.H.useSyncExternalStore(c,g,M)},k.useTransition=function(){return F.H.useTransition()},k.version="19.2.8",k}var Ud;function Ef(){return Ud||(Ud=1,xf.exports=b0()),xf.exports}var Ye=Ef();const x0=Vd(Ye);var Sf={exports:{}},qn={},zf={exports:{}},Mf={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Rd;function S0(){return Rd||(Rd=1,(function(z){function R(S,O){var X=S.length;S.push(O);e:for(;0<X;){var re=X-1>>>1,h=S[re];if(0<Y(h,O))S[re]=O,S[X]=h,X=re;else break e}}function D(S){return S.length===0?null:S[0]}function m(S){if(S.length===0)return null;var O=S[0],X=S.pop();if(X!==O){S[0]=X;e:for(var re=0,h=S.length,c=h>>>1;re<c;){var g=2*(re+1)-1,M=S[g],A=g+1,E=S[A];if(0>Y(M,X))A<h&&0>Y(E,M)?(S[re]=E,S[A]=X,re=A):(S[re]=M,S[g]=X,re=g);else if(A<h&&0>Y(E,X))S[re]=E,S[A]=X,re=A;else break e}}return O}function Y(S,O){var X=S.sortIndex-O.sortIndex;return X!==0?X:S.id-O.id}if(z.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var C=performance;z.unstable_now=function(){return C.now()}}else{var $=Date,he=$.now();z.unstable_now=function(){return $.now()-he}}var q=[],N=[],Z=1,G=null,ue=3,Fe=!1,Ze=!1,Ge=!1,se=!1,Ie=typeof setTimeout=="function"?setTimeout:null,Lt=typeof clearTimeout=="function"?clearTimeout:null,Ee=typeof setImmediate<"u"?setImmediate:null;function lt(S){for(var O=D(N);O!==null;){if(O.callback===null)m(N);else if(O.startTime<=S)m(N),O.sortIndex=O.expirationTime,R(q,O);else break;O=D(N)}}function St(S){if(Ge=!1,lt(S),!Ze)if(D(q)!==null)Ze=!0,ke||(ke=!0,Je());else{var O=D(N);O!==null&&Pe(St,O.startTime-S)}}var ke=!1,F=-1,Ke=5,zt=-1;function rl(){return se?!0:!(z.unstable_now()-zt<Ke)}function Mt(){if(se=!1,ke){var S=z.unstable_now();zt=S;var O=!0;try{e:{Ze=!1,Ge&&(Ge=!1,Lt(F),F=-1),Fe=!0;var X=ue;try{t:{for(lt(S),G=D(q);G!==null&&!(G.expirationTime>S&&rl());){var re=G.callback;if(typeof re=="function"){G.callback=null,ue=G.priorityLevel;var h=re(G.expirationTime<=S);if(S=z.unstable_now(),typeof h=="function"){G.callback=h,lt(S),O=!0;break t}G===D(q)&&m(q),lt(S)}else m(q);G=D(q)}if(G!==null)O=!0;else{var c=D(N);c!==null&&Pe(St,c.startTime-S),O=!1}}break e}finally{G=null,ue=X,Fe=!1}O=void 0}}finally{O?Je():ke=!1}}}var Je;if(typeof Ee=="function")Je=function(){Ee(Mt)};else if(typeof MessageChannel<"u"){var Zt=new MessageChannel,Tt=Zt.port2;Zt.port1.onmessage=Mt,Je=function(){Tt.postMessage(null)}}else Je=function(){Ie(Mt,0)};function Pe(S,O){F=Ie(function(){S(z.unstable_now())},O)}z.unstable_IdlePriority=5,z.unstable_ImmediatePriority=1,z.unstable_LowPriority=4,z.unstable_NormalPriority=3,z.unstable_Profiling=null,z.unstable_UserBlockingPriority=2,z.unstable_cancelCallback=function(S){S.callback=null},z.unstable_forceFrameRate=function(S){0>S||125<S?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Ke=0<S?Math.floor(1e3/S):5},z.unstable_getCurrentPriorityLevel=function(){return ue},z.unstable_next=function(S){switch(ue){case 1:case 2:case 3:var O=3;break;default:O=ue}var X=ue;ue=O;try{return S()}finally{ue=X}},z.unstable_requestPaint=function(){se=!0},z.unstable_runWithPriority=function(S,O){switch(S){case 1:case 2:case 3:case 4:case 5:break;default:S=3}var X=ue;ue=S;try{return O()}finally{ue=X}},z.unstable_scheduleCallback=function(S,O,X){var re=z.unstable_now();switch(typeof X=="object"&&X!==null?(X=X.delay,X=typeof X=="number"&&0<X?re+X:re):X=re,S){case 1:var h=-1;break;case 2:h=250;break;case 5:h=1073741823;break;case 4:h=1e4;break;default:h=5e3}return h=X+h,S={id:Z++,callback:O,priorityLevel:S,startTime:X,expirationTime:h,sortIndex:-1},X>re?(S.sortIndex=X,R(N,S),D(q)===null&&S===D(N)&&(Ge?(Lt(F),F=-1):Ge=!0,Pe(St,X-re))):(S.sortIndex=h,R(q,S),Ze||Fe||(Ze=!0,ke||(ke=!0,Je()))),S},z.unstable_shouldYield=rl,z.unstable_wrapCallback=function(S){var O=ue;return function(){var X=ue;ue=O;try{return S.apply(this,arguments)}finally{ue=X}}}})(Mf)),Mf}var Hd;function z0(){return Hd||(Hd=1,zf.exports=S0()),zf.exports}var Tf={exports:{}},$e={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Bd;function M0(){if(Bd)return $e;Bd=1;var z=Ef();function R(q){var N="https://react.dev/errors/"+q;if(1<arguments.length){N+="?args[]="+encodeURIComponent(arguments[1]);for(var Z=2;Z<arguments.length;Z++)N+="&args[]="+encodeURIComponent(arguments[Z])}return"Minified React error #"+q+"; visit "+N+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function D(){}var m={d:{f:D,r:function(){throw Error(R(522))},D,C:D,L:D,m:D,X:D,S:D,M:D},p:0,findDOMNode:null},Y=Symbol.for("react.portal");function C(q,N,Z){var G=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:Y,key:G==null?null:""+G,children:q,containerInfo:N,implementation:Z}}var $=z.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function he(q,N){if(q==="font")return"";if(typeof N=="string")return N==="use-credentials"?N:""}return $e.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=m,$e.createPortal=function(q,N){var Z=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!N||N.nodeType!==1&&N.nodeType!==9&&N.nodeType!==11)throw Error(R(299));return C(q,N,null,Z)},$e.flushSync=function(q){var N=$.T,Z=m.p;try{if($.T=null,m.p=2,q)return q()}finally{$.T=N,m.p=Z,m.d.f()}},$e.preconnect=function(q,N){typeof q=="string"&&(N?(N=N.crossOrigin,N=typeof N=="string"?N==="use-credentials"?N:"":void 0):N=null,m.d.C(q,N))},$e.prefetchDNS=function(q){typeof q=="string"&&m.d.D(q)},$e.preinit=function(q,N){if(typeof q=="string"&&N&&typeof N.as=="string"){var Z=N.as,G=he(Z,N.crossOrigin),ue=typeof N.integrity=="string"?N.integrity:void 0,Fe=typeof N.fetchPriority=="string"?N.fetchPriority:void 0;Z==="style"?m.d.S(q,typeof N.precedence=="string"?N.precedence:void 0,{crossOrigin:G,integrity:ue,fetchPriority:Fe}):Z==="script"&&m.d.X(q,{crossOrigin:G,integrity:ue,fetchPriority:Fe,nonce:typeof N.nonce=="string"?N.nonce:void 0})}},$e.preinitModule=function(q,N){if(typeof q=="string")if(typeof N=="object"&&N!==null){if(N.as==null||N.as==="script"){var Z=he(N.as,N.crossOrigin);m.d.M(q,{crossOrigin:Z,integrity:typeof N.integrity=="string"?N.integrity:void 0,nonce:typeof N.nonce=="string"?N.nonce:void 0})}}else N==null&&m.d.M(q)},$e.preload=function(q,N){if(typeof q=="string"&&typeof N=="object"&&N!==null&&typeof N.as=="string"){var Z=N.as,G=he(Z,N.crossOrigin);m.d.L(q,Z,{crossOrigin:G,integrity:typeof N.integrity=="string"?N.integrity:void 0,nonce:typeof N.nonce=="string"?N.nonce:void 0,type:typeof N.type=="string"?N.type:void 0,fetchPriority:typeof N.fetchPriority=="string"?N.fetchPriority:void 0,referrerPolicy:typeof N.referrerPolicy=="string"?N.referrerPolicy:void 0,imageSrcSet:typeof N.imageSrcSet=="string"?N.imageSrcSet:void 0,imageSizes:typeof N.imageSizes=="string"?N.imageSizes:void 0,media:typeof N.media=="string"?N.media:void 0})}},$e.preloadModule=function(q,N){if(typeof q=="string")if(N){var Z=he(N.as,N.crossOrigin);m.d.m(q,{as:typeof N.as=="string"&&N.as!=="script"?N.as:void 0,crossOrigin:Z,integrity:typeof N.integrity=="string"?N.integrity:void 0})}else m.d.m(q)},$e.requestFormReset=function(q){m.d.r(q)},$e.unstable_batchedUpdates=function(q,N){return q(N)},$e.useFormState=function(q,N,Z){return $.H.useFormState(q,N,Z)},$e.useFormStatus=function(){return $.H.useHostTransitionStatus()},$e.version="19.2.8",$e}var qd;function T0(){if(qd)return Tf.exports;qd=1;function z(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(z)}catch(R){console.error(R)}}return z(),Tf.exports=M0(),Tf.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Yd;function j0(){if(Yd)return qn;Yd=1;var z=z0(),R=Ef(),D=T0();function m(e){var t="https://react.dev/errors/"+e;if(1<arguments.length){t+="?args[]="+encodeURIComponent(arguments[1]);for(var l=2;l<arguments.length;l++)t+="&args[]="+encodeURIComponent(arguments[l])}return"Minified React error #"+e+"; visit "+t+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function Y(e){return!(!e||e.nodeType!==1&&e.nodeType!==9&&e.nodeType!==11)}function C(e){var t=e,l=e;if(e.alternate)for(;t.return;)t=t.return;else{e=t;do t=e,(t.flags&4098)!==0&&(l=t.return),e=t.return;while(e)}return t.tag===3?l:null}function $(e){if(e.tag===13){var t=e.memoizedState;if(t===null&&(e=e.alternate,e!==null&&(t=e.memoizedState)),t!==null)return t.dehydrated}return null}function he(e){if(e.tag===31){var t=e.memoizedState;if(t===null&&(e=e.alternate,e!==null&&(t=e.memoizedState)),t!==null)return t.dehydrated}return null}function q(e){if(C(e)!==e)throw Error(m(188))}function N(e){var t=e.alternate;if(!t){if(t=C(e),t===null)throw Error(m(188));return t!==e?null:e}for(var l=e,a=t;;){var n=l.return;if(n===null)break;var i=n.alternate;if(i===null){if(a=n.return,a!==null){l=a;continue}break}if(n.child===i.child){for(i=n.child;i;){if(i===l)return q(n),e;if(i===a)return q(n),t;i=i.sibling}throw Error(m(188))}if(l.return!==a.return)l=n,a=i;else{for(var u=!1,f=n.child;f;){if(f===l){u=!0,l=n,a=i;break}if(f===a){u=!0,a=n,l=i;break}f=f.sibling}if(!u){for(f=i.child;f;){if(f===l){u=!0,l=i,a=n;break}if(f===a){u=!0,a=i,l=n;break}f=f.sibling}if(!u)throw Error(m(189))}}if(l.alternate!==a)throw Error(m(190))}if(l.tag!==3)throw Error(m(188));return l.stateNode.current===l?e:t}function Z(e){var t=e.tag;if(t===5||t===26||t===27||t===6)return e;for(e=e.child;e!==null;){if(t=Z(e),t!==null)return t;e=e.sibling}return null}var G=Object.assign,ue=Symbol.for("react.element"),Fe=Symbol.for("react.transitional.element"),Ze=Symbol.for("react.portal"),Ge=Symbol.for("react.fragment"),se=Symbol.for("react.strict_mode"),Ie=Symbol.for("react.profiler"),Lt=Symbol.for("react.consumer"),Ee=Symbol.for("react.context"),lt=Symbol.for("react.forward_ref"),St=Symbol.for("react.suspense"),ke=Symbol.for("react.suspense_list"),F=Symbol.for("react.memo"),Ke=Symbol.for("react.lazy"),zt=Symbol.for("react.activity"),rl=Symbol.for("react.memo_cache_sentinel"),Mt=Symbol.iterator;function Je(e){return e===null||typeof e!="object"?null:(e=Mt&&e[Mt]||e["@@iterator"],typeof e=="function"?e:null)}var Zt=Symbol.for("react.client.reference");function Tt(e){if(e==null)return null;if(typeof e=="function")return e.$$typeof===Zt?null:e.displayName||e.name||null;if(typeof e=="string")return e;switch(e){case Ge:return"Fragment";case Ie:return"Profiler";case se:return"StrictMode";case St:return"Suspense";case ke:return"SuspenseList";case zt:return"Activity"}if(typeof e=="object")switch(e.$$typeof){case Ze:return"Portal";case Ee:return e.displayName||"Context";case Lt:return(e._context.displayName||"Context")+".Consumer";case lt:var t=e.render;return e=e.displayName,e||(e=t.displayName||t.name||"",e=e!==""?"ForwardRef("+e+")":"ForwardRef"),e;case F:return t=e.displayName||null,t!==null?t:Tt(e.type)||"Memo";case Ke:t=e._payload,e=e._init;try{return Tt(e(t))}catch{}}return null}var Pe=Array.isArray,S=R.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,O=D.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,X={pending:!1,data:null,method:null,action:null},re=[],h=-1;function c(e){return{current:e}}function g(e){0>h||(e.current=re[h],re[h]=null,h--)}function M(e,t){h++,re[h]=e.current,e.current=t}var A=c(null),E=c(null),U=c(null),_=c(null);function w(e,t){switch(M(U,t),M(E,e),M(A,null),t.nodeType){case 9:case 11:e=(e=t.documentElement)&&(e=e.namespaceURI)?Po(e):0;break;default:if(e=t.tagName,t=t.namespaceURI)t=Po(t),e=ed(t,e);else switch(e){case"svg":e=1;break;case"math":e=2;break;default:e=0}}g(A),M(A,e)}function V(){g(A),g(E),g(U)}function ge(e){e.memoizedState!==null&&M(_,e);var t=A.current,l=ed(t,e.type);t!==l&&(M(E,e),M(A,l))}function oe(e){E.current===e&&(g(A),g(E)),_.current===e&&(g(_),On._currentValue=X)}var xe,_e;function J(e){if(xe===void 0)try{throw Error()}catch(l){var t=l.stack.trim().match(/\n( *(at )?)/);xe=t&&t[1]||"",_e=-1<l.stack.indexOf(`
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const C0=Ye.forwardRef(({color:z="currentColor",size:R=24,strokeWidth:D=2,absoluteStrokeWidth:m,className:Y="",children:C,iconNode:$,...he},q)=>Ye.createElement("svg",{ref:q,...D0,width:R,height:R,stroke:z,strokeWidth:m?Number(D)*24/Number(R):D,className:Zd("lucide",Y),...he},[...$.map(([N,Z])=>Ye.createElement(N,Z)),...Array.isArray(C)?C:[C]]));/**
 * @license lucide-react v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Y0=[["path",{d:"M20 6 9 17l-5-5",key:"1gmf2c"}]],Ld=ae("Check",Y0);/**
 * @license lucide-react v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const L0=[["path",{d:"M17.5 19H9a7 7 0 1 1 6.71-9h1.79a4.5 4.5 0 1 1 0 9Z",key:"p7xjir"}]],w0=ae("Cloud",L0);/**
 * @license lucide-react v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const V0=[["polyline",{points:"16 18 22 12 16 6",key:"z7tu5w"}],["polyline",{points:"8 6 2 12 8 18",key:"1eg1df"}]],wd=ae("Code",V0);/**
 * @license lucide-react v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const I0=[["path",{d:"M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z",key:"1rqfz7"}],["path",{d:"M14 2v4a2 2 0 0 0 2 2h4",key:"tnqrlb"}],["path",{d:"M10 9H8",key:"b1mrlr"}],["path",{d:"M16 13H8",key:"t4e002"}],["path",{d:"M16 17H8",key:"z1uh3a"}]],jf=ae("FileText",I0);/**
 * @license lucide-react v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const r1=[["rect",{width:"18",height:"11",x:"3",y:"11",rx:"2",ry:"2",key:"1w4ew1"}],["path",{d:"M7 11V7a5 5 0 0 1 10 0v4",key:"fwvmzm"}]],Nf=ae("Lock",r1);/**
 * @license lucide-react v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const g1=[["path",{d:"M12 3a6 6 0 0 0 9 9 9 9 0 1 1-9-9Z",key:"a7tn18"}]],v1=ae("Moon",g1);/**
 * @license lucide-react v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const z1=[["path",{d:"M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z",key:"oel41y"}],["path",{d:"m9 12 2 2 4-4",key:"dzmm74"}]],M1=ae("ShieldCheck",z1);/**
 * @license lucide-react v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const j1=[["circle",{cx:"12",cy:"12",r:"4",key:"4exip2"}],["path",{d:"M12 2v2",key:"tus03m"}],["path",{d:"M12 20v2",key:"1lh1kg"}],["path",{d:"m4.93 4.93 1.41 1.41",key:"149t6j"}],["path",{d:"m17.66 17.66 1.41 1.41",key:"ptbguv"}],["path",{d:"M2 12h2",key:"1t8f8n"}],["path",{d:"M20 12h2",key:"1q8mjw"}],["path",{d:"m6.34 17.66-1.41 1.41",key:"1m8zz5"}],["path",{d:"m19.07 4.93-1.41 1.41",key:"1shlcs"}]],N1=ae("Sun",j1);/**
 * @license lucide-react v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 */const E1=[["path",{d:"M18 6 6 18",key:"1bl5f8"}],["path",{d:"m6 6 12 12",key:"d8bk6v"}]],em=ae("X",E1),fe={name:"Dang Anh Tuong",nickname:"tuongok",brandLogo:"TUONG-DEV",title:"Software Engineer | Frontend & Full-Stack Development",targetRole:"Seeking Full-Stack / Frontend Software Engineer Internship",location:"Ho Chi Minh City, Vietnam",email:"danganhtuongg@gmail.com",phone:"0335847674",github:"https://github.com/DangAnhTuong",githubUsername:"DangAnhTuong",linkedin:"https://www.linkedin.com/in/đặng-anh-tường-726574361?utm_source=share_via&utm_content=profile&utm_medium=member_ios",cvUrl:"/Dang_Anh_Tuong_CV.pdf",summary:"Final-year Information Technology student at Thuyloi University (HCMC) seeking a Full-stack / Frontend Software Engineer Internship. Possesses hands-on experience developing full-stack web applications with React 19, Three.js, Node.js, and Python FastAPI. Proficient in real-time AI streaming, 3D web rendering, database architecture, and cutting-edge AI-assisted engineering workflows (Google Antigravity, Claude Code, OpenAI Codex, Cursor). Certified English proficiency at CEFR B1 level.",education:{university:"Thuyloi University",location:"Ho Chi Minh City, Vietnam",degree:"Bachelor of Science in Information Technology – 4th Year",timeline:"2023 – Present (Expected Graduation: 2027)",englishCert:"Certified CEFR B1 Standard (University Exit Benchmark)",nativeLang:"Vietnamese (Native)"},stats:[{label:"Academic Standing",value:"4th Year · Thuyloi Univ"},{label:"Target Opportunity",value:"Internship / Full-Stack"},{label:"Core Stack",value:"React 19 · Three.js · Node.js"},{label:"English Proficiency",value:"CEFR B1 Certified"}]},_1=[{id:"all",label:"All Projects"},{id:"fullstack",label:"Full-Stack & Backend"},{id:"creative",label:"3D Web & Interactive"},{id:"ai-data",label:"AI & Data Systems"}],Qd=[{id:"tuong-tan-toeic",title:"Tường Tận TOEIC – Comprehensive 4-Skill EdTech & Test Preparation Platform",category:"fullstack",featured:!0,role:"Full-stack Engineer | Flagship Production Project",timeline:"Jan. 2026 – Production Live",tagline:"Commercial-grade TOEIC exam ecosystem featuring SM-2 Spaced Repetition, real-time dictation diff engine, and full 200-question ETS mock exam rooms",description:"Designed, engineered, and deployed an end-to-end 4-skill TOEIC preparation platform hosting 18,200 ETS practice questions, 11,785 dictation audio exercises, and 3,500+ Spaced Repetition vocabulary flashcards. Integrated Google 1-Click OAuth 2.0, automated VietQR payment webhooks, and zero-overflow native mobile UX. Deployed to Linux VPS with Nginx and SSL.",techStack:["React 18","Node.js (Express)","MongoDB","TailwindCSS","Vite","JWT Auth","Google OAuth 2.0","Web Audio API","VietQR","Nginx","Linux VPS"],bullets:["4-Skill EdTech Ecosystem: Delivered 18,200 ETS questions with 4-part pedagogical explanations, 11,785 dictation audio sentences with live word-level diffing, and 83 SM-2 vocabulary topics.","High-Precision Audio & Exam Rooms: Engineered 100vh no-scroll ETS exam simulator with 200-question bubble sheets, single-sentence waveform audio streaming, and zero-spoil interactive blank inputs with auto-advance.","Secure Auth & Automated Monetization: Built 100% Google 1-Click OAuth 2.0 authentication, role-based access control (RBAC), and automated VietQR payment webhook integration for instant 120-day VIP membership provisioning.","Native Mobile UX & Production DevOps: Optimized mobile layouts with thumb-zone bottom navigation and off-canvas drawers; established an automated 5-step CI/CD pipeline deployed on Ubuntu VPS via Nginx reverse proxy with SSL."],architecture:{frontend:"React 18, Vite 5, TailwindCSS, Web Audio API, Native Speech API, Lucide React, Custom SM-2 Active Recall Engine",backend:"Node.js Express API (v1), JWT RBAC Middleware, Google OAuth2 Token Verification, VietQR Webhook Listener",database:"MongoDB & Mongoose (18,000+ indexed questions, full-text search, user progress tracking & mistake notebooks)",devops:"Ubuntu Linux VPS, Nginx Reverse Proxy, Let's Encrypt SSL, PM2 Process Manager, Automated 5-Step CI/CD"},github:"https://github.com/DangAnhTuong/tuong_tan_toeic",demo:"https://toeic.danganhtuong.dev",isPrivate:!0,privateNotice:"Mã nguồn đang ở chế độ Private để bảo vệ tài nguyên đề thi. Sẵn sàng mời làm Collaborator/Viewer cho Nhà tuyển dụng quan tâm.",badgeColor:"#3b82f6",gradient:"linear-gradient(135deg, #1d4ed8 0%, #38bdf8 100%)"},{id:"ai-english",title:"AI-Powered English Learning Platform",category:"ai-data",featured:!0,role:"Full-stack Developer | Personal Project",timeline:"Jan. 2026 – Present",tagline:"Microservices platform with real-time AI voice streaming and automated pronunciation scoring",description:"Designed and engineered a decoupled full-stack platform combining Node.js for auth/business logic and Python FastAPI for real-time speech processing. Integrated Deepgram STT and OpenAI via WebSockets for sub-1.5s audio evaluation.",techStack:["React 19","Node.js (Express)","Python (FastAPI)","MongoDB","Redis","WebSockets","Docker","Nginx"],bullets:["Microservices Architecture: Designed a decoupled backend system combining Node.js for business logic/auth and Python FastAPI for real-time AI speech processing.","Real-time Voice Streaming: Integrated Deepgram STT and OpenAI API via WebSockets for instant speech recognition, low-latency audio feedback (<1.5s), and automated pronunciation scoring.","Authentication & Security: Implemented JWT authentication with refresh token flow, Google OAuth2, and Role-Based Access Control (RBAC) across learner and admin portals.","DevOps & Infrastructure: Containerized application stack using Docker Compose and Nginx Reverse Proxy on Linux VPS; configured zero-cache HTTP headers for SPA static bundle delivery."],architecture:{frontend:"React 19, Vite, Web Audio API, WebSocket client",backend:"Node.js Express (Auth & Business API), Python FastAPI (Speech Inference Engine)",database:"MongoDB, Redis (Cache & Session state)",devops:"Docker Compose, Nginx Reverse Proxy, Linux VPS"},github:"https://github.com/DangAnhTuong/ai-english-learning-platform",demo:"https://english.danganhtuong.dev",badgeColor:"#10b981",gradient:"linear-gradient(135deg, #059669 0%, #10b981 100%)"},{id:"tuong-hotel",title:"Tuong Hotel – 3D Showcase & Reservation System",category:"creative",featured:!0,role:"Frontend Developer | Personal Project",timeline:"June 2025 – Aug. 2025",tagline:"Interactive 3D luxury hotel showcase and reservation system powered by Three.js WebGL",description:"Built an interactive luxury hotel website featuring real-time 3D graphics rendering with Three.js. Implemented room showcases, dining menus, tour booking flows, and smooth 60 FPS performance optimization.",techStack:["React 19","Three.js (@react-three/fiber)","Ant Design 5","HTML5","CSS3","i18next","Netlify"],bullets:["3D Graphics & UI Design: Built an interactive luxury hotel website featuring 3D graphics rendering with Three.js, room showcases, dining menus, and tour booking flows.","Multi-language Integration: Integrated Ant Design 5 UI components, custom keyframe animations, and i18next for seamless bilingual (English/Vietnamese) support for international guests.","Performance & Deployment: Optimized 3D model assets and geometry loading to maintain smooth 60 FPS rendering; deployed production build to Netlify with continuous deployment pipelines."],architecture:{core:"React 19, Three.js, @react-three/fiber, @react-three/drei",ui:"Ant Design 5, Lucide Icons, Custom Keyframe CSS",i18n:"i18next (English & Vietnamese bilingual routing)",deployment:"Netlify Continuous Deployment (CI/CD)"},github:"https://github.com/DangAnhTuong/tuong-hotel",demo:"https://tuong-hotel.vercel.app",badgeColor:"#0ea5e9",gradient:"linear-gradient(135deg, #0ea5e9 0%, #06b6d4 100%)"},{id:"tickethub",title:"TicketHub – Enterprise Event Ticketing Platform",category:"fullstack",featured:!0,role:"Full-stack Engineer | Personal Project",timeline:"2025",tagline:"High-concurrency ticket distribution platform with distributed locking and queue management",description:"Engineered a robust event ticketing infrastructure designed to prevent race conditions during high-demand concert ticket sales using Redis Distributed Locks and BullMQ job queues.",techStack:["Next.js 19","NestJS","TypeScript","PostgreSQL","Redis","BullMQ","Prisma ORM","Docker Compose"],bullets:["High Concurrency Engine: Solved ticket race conditions using Redis Distributed Lock mechanisms.","Queue Architecture: Built BullMQ job queues to smooth out thousand-request traffic spikes without server crashes.","Enterprise Architecture: Decoupled NestJS backend with Prisma ORM, PostgreSQL, and strict RBAC authorization.","Full Containerization: Shipped complete multi-container Docker Compose setup ready for cloud or VPS."],architecture:{frontend:"Next.js 19 (TypeScript), Framer Motion, Lucide Icons",backend:"NestJS, Prisma ORM, JWT, RBAC Guards, Swagger Docs",database:"PostgreSQL, Redis (Distributed Lock & BullMQ Job Queue)",devops:"Docker Compose All-in-One, Nginx Reverse Proxy"},github:"https://github.com/DangAnhTuong/event_ticketing_platform-",demo:"https://event-ticketing-platform-omega.vercel.app",badgeColor:"#6366f1",gradient:"linear-gradient(135deg, #4f46e5 0%, #7c3aed 100%)"},{id:"olist-analytics",title:"Olist E-Commerce Analytics End-to-End",category:"ai-data",featured:!1,role:"Data & ML Engineer | Academic Project",timeline:"2025",tagline:"Customer segmentation & churn prediction pipeline on 100,000+ e-commerce orders",description:"End-to-end data science and machine learning project analyzing Brazilian e-commerce transactions. Built RFM customer segmentation and predictive churn classification models.",techStack:["Python","Pandas","Scikit-Learn","NumPy","Seaborn","Streamlit","Matplotlib"],bullets:["Large-scale Data Pipeline: Cleaned and normalized complex multi-table relational datasets covering 100,000 orders.","RFM Customer Segmentation: Applied K-Means clustering to identify high-value consumer groups.","Predictive Modeling: Trained classification models (Random Forest, Logistic Regression) to assess delivery delays and satisfaction.","Interactive Dashboard: Deployed an exploratory data visualization application using Streamlit Cloud."],architecture:{dataProcessing:"Python, Pandas, NumPy, Scipy",machineLearning:"Scikit-Learn (K-Means, Random Forest, Logistic Regression)",visualization:"Plotly, Seaborn, Matplotlib",dashboard:"Streamlit Community Cloud"},github:"https://github.com/DangAnhTuong/Olist-Ecommerce-Analytics-End-to-End",demo:"/Olist_Analytics_Report.pdf",badgeColor:"#f59e0b",gradient:"linear-gradient(135deg, #d97706 0%, #f59e0b 100%)"}],D1=[{category:"Frontend Development",icon:"Layout",skills:["React 19 / 18","Next.js","TailwindCSS","Three.js (@react-three/fiber)","JavaScript (ES6+)","HTML5","CSS3","Ant Design","Web Audio API"]},{category:"Backend Development",icon:"Server",skills:["Node.js (Express)","Python (FastAPI)","RESTful APIs","WebSockets","Mongoose","JWT Auth","OAuth 2.0"]},{category:"Programming Languages",icon:"Code",skills:["JavaScript","Python","C++","Java"]},{category:"Database & Storage",icon:"Database",skills:["MongoDB","PostgreSQL","MySQL","Redis"]},{category:"AI & Agentic Tools",icon:"Cpu",skills:["Google Antigravity","Claude Code","OpenAI Codex","Cursor IDE","Prompt Engineering"]},{category:"DevOps & Cloud",icon:"Cloud",skills:["Docker","Docker Compose","Nginx Reverse Proxy","Linux VPS","PM2","Git","GitHub","Vercel","Netlify"]},{category:"Foreign Languages",icon:"Globe",skills:["English (CEFR B1 Certified)","Vietnamese (Native)"]}];function C1({theme:z,toggleTheme:R}){const[D,m]=Ye.useState(!1),[Y,C]=Ye.useState(!1);return Ye.useEffect(()=>{const $=()=>{m(window.scrollY>20)};return window.addEventListener("scroll",$),()=>window.removeEventListener("scroll",$)},[]),s.jsxs("header",{className:`navbar-wrapper ${D?"navbar-scrolled":""}`,children:[s.jsxs("div",{className:"container navbar-container",children:[s.jsxs("a",{href:"#home",className:"navbar-brand",children:[s.jsx("div",{className:"brand-icon",children:s.jsx(Pd,{size:17,color:"var(--accent-cyan)"})}),s.jsxs("div",{className:"brand-text",children:[s.jsx("span",{className:"brand-name",children:fe.brandLogo}),s.jsx("span",{className:"brand-role",children:"Software Engineer"})]})]}),s.jsxs("nav",{className:"nav-links",children:[s.jsx("a",{href:"#home",className:"nav-item",children:"Home"}),s.jsx("a",{href:"#about",className:"nav-item",children:"About"}),s.jsx("a",{href:"#projects",className:"nav-item",children:"Projects"}),s.jsx("a",{href:"#contact",className:"nav-item",children:"Contact"})]}),s.jsxs("div",{className:"navbar-actions",children:[s.jsx("button",{className:"theme-toggle-btn",onClick:R,"aria-label":`Switch to ${z==="dark"?"Light":"Dark"} mode`,title:`Switch to ${z==="dark"?"Light":"Dark"} mode`,children:z==="dark"?s.jsx(N1,{size:18,color:"#fbbf24",className:"theme-icon"}):s.jsx(v1,{size:18,color:"#6366f1",className:"theme-icon"})}),s.jsxs("a",{href:fe.cvUrl,target:"_blank",rel:"noopener noreferrer",className:"btn btn-primary btn-sm",title:"Download Official Resume PDF",children:[s.jsx(jf,{size:15}),s.jsx("span",{children:"Resume"})]}),s.jsx("button",{className:"mobile-toggle-btn",onClick:()=>C(!Y),"aria-label":"Toggle Navigation",children:Y?s.jsx(em,{size:22}):s.jsx(h1,{size:22})})]})]}),Y&&s.jsxs("div",{className:"mobile-menu glass-panel",children:[s.jsx("a",{href:"#home",onClick:()=>C(!1),className:"mobile-nav-item",children:"Home"}),s.jsx("a",{href:"#about",onClick:()=>C(!1),className:"mobile-nav-item",children:"About Me"}),s.jsx("a",{href:"#projects",onClick:()=>C(!1),className:"mobile-nav-item",children:"Featured Projects"}),s.jsx("a",{href:"#contact",onClick:()=>C(!1),className:"mobile-nav-item",children:"Contact"}),s.jsxs("a",{href:fe.cvUrl,target:"_blank",rel:"noopener noreferrer",className:"btn btn-primary btn-sm",style:{marginTop:"8px"},children:[s.jsx(jf,{size:16}),s.jsx("span",{children:"Download Resume PDF"})]})]}),s.jsx("style",{children:`
      ...
      `})]})}var Of={};(function z(R,D,m,Y){var C=!!(R.Worker&&R.Blob&&R.Promise&&R.OffscreenCanvas&&R.OffscreenCanvasRenderingContext2D&&R.HTMLCanvasElement&&R.HTMLCanvasElement.prototype.transferControlToOffscreen&&R.URL&&R.URL.createObjectURL),$=typeof Path2D=="function"&&typeof DOMMatrix=="function",he=(function(){if(!R.OffscreenCanvas)return!1;try{var h=new OffscreenCanvas(1,1),c=h.getContext("2d");c.fillRect(0,0,1,1);var g=h.transferToImageBitmap();c.createPattern(g,"no-repeat")}catch{return!1}return!0})();function q(){}function N(h){var c=D.exports.Promise,g=c!==void 0?c:R.Promise;return typeof g=="function"?new g(h):(h(q,q),null)}var Z=(function(h,c){return{transform:function(g){if(h)return g;if(c.has(g))return c.get(g);var M=new OffscreenCanvas(g.width,g.height),A=M.getContext("2d");return A.drawImage(g,0,0),c.set(g,M),M},clear:function(){c.clear()}}})(he,new Map),G=(function(){var h=Math.floor(16.666666666666668),c,g,M={},A=0;return typeof requestAnimationFrame=="function"&&typeof cancelAnimationFrame=="function"?(c=function(E){var U=Math.random();return M[U]=requestAnimationFrame(function _(w){A===w||A+h-1<w?(A=w,delete M[U],E()):M[U]=requestAnimationFrame(_)}),U},g=function(E){M[E]&&cancelAnimationFrame(M[E])}):(c=function(E){return setTimeout(E,h)},g=function(E){return clearTimeout(E)}),{frame:c,cancel:g}})(),ue=(function(){var h,c,g={};function M(A){function E(U,_){A.postMessage({options:U||{},callback:_})}A.init=function(_){var w=_.transferControlToOffscreen();A.postMessage({canvas:w},[w])},A.fire=function(_,w,V){if(c)return E(_,null),c;var ge=Math.random().toString(36).slice(2);return c=N(function(oe){function xe(_e){_e.data.callback===ge&&(delete g[ge],A.removeEventListener("message",xe),c=null,Z.clear(),V(),oe())}A.addEventListener("message",xe),E(_,ge),g[ge]=xe.bind(null,{data:{callback:ge}})}),c},A.reset=function(){A.postMessage({reset:!0});for(var _ in g)g[_](),delete g[_]}}return function(){if(h)return h;if(!m&&C){var A=["var CONFETTI, SIZE = {}, module = {};","("+z.toString()+")(this, module, true, SIZE);","onmessage = function(msg) {","  if (msg.data.options) {","    CONFETTI(msg.data.options).then(function () {","      if (msg.data.callback) {","        postMessage({ callback: msg.data.callback });","      }","    });","  } else if (msg.data.reset) {","    CONFETTI && CONFETTI.reset();","  } else if (msg.data.resize) {","    SIZE.width = msg.data.resize.width;","    SIZE.height = msg.data.resize.height;","  } else if (msg.data.canvas) {","    SIZE.width = msg.data.canvas.width;","    SIZE.height = msg.data.canvas.height;","    CONFETTI = module.exports.create(msg.data.canvas);","  }","}"].join(`
`);try{h=new Worker(URL.createObjectURL(new Blob([A])))}catch(E){return typeof console<"u"&&typeof console.warn=="function"&&console.warn("🎊 Could not load worker",E),null}M(h)}return h}})(),Fe={particleCount:50,angle:90,spread:45,startVelocity:45,decay:.9,gravity:1,drift:0,ticks:200,x:.5,y:.5,shapes:["square","circle"],zIndex:100,colors:["#26ccff","#a25afd","#ff5e7e","#88ff5a","#fcff42","#ffa62d","#ff36ff"],disableForReducedMotion:!1,scalar:1};function Ze(h,c){return c?c(h):h}function Ge(h){return h!=null}function se(h,c,g){return Ze(h&&Ge(h[c])?h[c]:Fe[c],g)}function Ie(h){return h<0?0:Math.floor(h)}function Lt(h,c){return Math.floor(Math.random()*(c-h))+h}function Ee(h){return parseInt(h,16)}function lt(h){return h.map(St)}function St(h){var c=String(h).replace(/[^0-9a-f]/gi,"");return c.length<6&&(c=c[0]+c[0]+c[1]+c[1]+c[2]+c[2]),{r:Ee(c.substring(0,2)),g:Ee(c.substring(2,4)),b:Ee(c.substring(4,6))}}function ke(h){var c=se(h,"origin",Object);return c.x=se(c,"x",Number),c.y=se(c,"y",Number),c}function F(h){h.width=document.documentElement.clientWidth,h.height=document.documentElement.clientHeight}function Ke(h){var c=h.getBoundingClientRect();h.width=c.width,h.height=c.height}function zt(h){var c=document.createElement("canvas");return c.style.position="fixed",c.style.top="0px",c.style.left="0px",c.style.pointerEvents="none",c.style.zIndex=h,c}function rl(h,c,g,M,A,E,U,_,w){h.save(),h.translate(c,g),h.rotate(E),h.scale(M,A),h.arc(0,0,1,U,_,w),h.restore()}function Mt(h){var c=h.angle*(Math.PI/180),g=h.spread*(Math.PI/180);return{x:h.x,y:h.y,wobble:Math.random()*10,wobbleSpeed:Math.min(.11,Math.random()*.1+.05),velocity:h.startVelocity*.5+Math.random()*h.startVelocity,angle2D:-c+(.5*g-Math.random()*g),tiltAngle:(Math.random()*(.75-.25)+.25)*Math.PI,color:h.color,shape:h.shape,tick:0,totalTicks:h.ticks,decay:h.decay,drift:h.drift,random:Math.random()+2,tiltSin:0,tiltCos:0,wobbleX:0,wobbleY:0,gravity:h.gravity*3,ovalScalar:.6,scalar:h.scalar,flat:h.flat}}function Je(h,c){c.x+=Math.cos(c.angle2D)*c.velocity+c.drift,c.y+=Math.sin(c.angle2D)*c.velocity+c.gravity,c.velocity*=c.decay,c.flat?(c.wobble=0,c.wobbleX=c.x+10*c.scalar,c.wobbleY=c.y+10*c.scalar,c.tiltSin=0,c.tiltCos=0,c.random=1):(c.wobble+=c.wobbleSpeed,c.wobbleX=c.x+10*c.scalar*Math.cos(c.wobble),c.wobbleY=c.y+10*c.scalar*Math.sin(c.wobble),c.tiltAngle+=.1,c.tiltSin=Math.sin(c.tiltAngle),c.tiltCos=Math.cos(c.tiltAngle),c.random=Math.random()+2);var g=c.tick++/c.totalTicks,M=c.x+c.random*c.tiltCos,A=c.y+c.random*c.tiltSin,E=c.wobbleX+c.random*c.tiltCos,U=c.wobbleY+c.random*c.tiltSin;if(h.fillStyle="rgba("+c.color.r+", "+c.color.g+", "+c.color.b+", "+(1-g)+")",h.beginPath(),$&&c.shape.type==="path"&&typeof c.shape.path=="string"&&Array.isArray(c.shape.matrix))h.fill(O(c.shape.path,c.shape.matrix,c.x,c.y,Math.abs(E-M)*.1,Math.abs(U-A)*.1,Math.PI/10*c.wobble));else if(c.shape.type==="bitmap"){var _=Math.PI/10*c.wobble,w=Math.abs(E-M)*.1,V=Math.abs(U-A)*.1,ge=c.shape.bitmap.width*c.scalar,oe=c.shape.bitmap.height*c.scalar,xe=new DOMMatrix([Math.cos(_)*w,Math.sin(_)*w,-Math.sin(_)*V,Math.cos(_)*V,c.x,c.y]);xe.multiplySelf(new DOMMatrix(c.shape.matrix));var _e=h.createPattern(Z.transform(c.shape.bitmap),"no-repeat");_e.setTransform(xe),h.globalAlpha=1-g,h.fillStyle=_e,h.fillRect(c.x-ge/2,c.y-oe/2,ge,oe),h.globalAlpha=1}else if(c.shape==="circle")h.ellipse?h.ellipse(c.x,c.y,Math.abs(E-M)*c.ovalScalar,Math.abs(U-A)*c.ovalScalar,Math.PI/10*c.wobble,0,2*Math.PI):rl(h,c.x,c.y,Math.abs(E-M)*c.ovalScalar,Math.abs(U-A)*c.ovalScalar,Math.PI/10*c.wobble,0,2*Math.PI);else if(c.shape==="star")for(var J=Math.PI/2*3,He=4*c.scalar,et=8*c.scalar,ot=c.x,jt=c.y,Bt=5,at=Math.PI/Bt;Bt--;)ot=c.x+Math.cos(J)*et,jt=c.y+Math.sin(J)*et,h.lineTo(ot,jt),J+=at,ot=c.x+Math.cos(J)*He,jt=c.y+Math.sin(J)*He,h.lineTo(ot,jt),J+=at;else h.moveTo(Math.floor(c.x),Math.floor(c.y)),h.lineTo(Math.floor(c.wobbleX),Math.floor(A)),h.lineTo(Math.floor(E),Math.floor(U)),h.lineTo(Math.floor(M),Math.floor(c.wobbleY));return h.closePath(),h.fill(),c.tick<c.totalTicks}function Zt(h,c,g,M,A){var E=c.slice(),U=h.getContext("2d"),_,w,V=N(function(ge){function oe(){_=w=null,U.clearRect(0,0,M.width,M.height),Z.clear(),A(),ge()}function xe(){m&&!(M.width===Y.width&&M.height===Y.height)&&(M.width=h.width=Y.width,M.height=h.height=Y.height),!M.width&&!M.height&&(g(h),M.width=h.width,M.height=h.height),U.clearRect(0,0,M.width,M.height),E=E.filter(function(_e){return Je(U,_e)}),E.length?_=G.frame(xe):oe()}_=G.frame(xe),w=oe});return{addFettis:function(ge){return E=E.concat(ge),V},canvas:h,promise:V,reset:function(){_&&G.cancel(_),w&&w()}}}function Tt(h,c){var g=!h,M=!!se(c||{},"resize"),A=!1,E=se(c,"disableForReducedMotion",Boolean),U=C&&!!se(c||{},"useWorker"),_=U?ue():null,w=g?F:Ke,V=h&&_?!!h.__confetti_initialized:!1,ge=typeof matchMedia=="function"&&matchMedia("(prefers-reduced-motion)").matches,oe;function xe(J,He,et){for(var ot=se(J,"particleCount",Ie),jt=se(J,"angle",Number),Bt=se(J,"spread",Number),at=se(J,"startVelocity",Number),La=se(J,"decay",Number),lu=se(J,"gravity",Number),au=se(J,"drift",Number),We=se(J,"colors",lt),nu=se(J,"ticks",Number),wa=se(J,"shapes"),Yn=se(J,"scalar"),ta=!!se(J,"flat"),Gn=ke(J),Qa=ot,Xa=[],iu=h.width*Gn.x,Bl=h.height*Gn.y;Qa--;)Xa.push(Mt({x:iu,y:Bl,angle:jt,spread:Bt,startVelocity:at,color:We[Qa%We.length],shape:wa[Lt(0,wa.length)],ticks:nu,decay:La,gravity:lu,drift:au,scalar:Yn,flat:ta}));return oe?oe.addFettis(Xa):(oe=Zt(h,Xa,w,He,et),oe.promise)}function _e(J){var He=E||se(J,"disableForReducedMotion",Boolean),et=se(J,"zIndex",Number);if(He&&ge)return N(function(at){at()});g&&oe?h=oe.canvas:g&&!h&&(h=zt(et),document.body.appendChild(h)),M&&!V&&w(h);var ot={width:h.width,height:h.height};_&&!V&&_.init(h),V=!0,_&&(h.__confetti_initialized=!0);function jt(){if(_){var at={getBoundingClientRect:function(){if(!g)return h.getBoundingClientRect()}};w(at),_.postMessage({resize:{width:at.width,height:at.height}});return}ot.width=ot.height=null}function Bt(){oe=null,M&&(A=!1,R.removeEventListener("resize",jt)),g&&h&&(document.body.contains(h)&&document.body.removeChild(h),h=null,V=!1)}return M&&!A&&(A=!0,R.addEventListener("resize",jt,!1)),_?_.fire(J,ot,Bt):xe(J,ot,Bt)}return _e.reset=function(){_&&_.reset(),oe&&oe.reset()},_e}var Pe;function S(){return Pe||(Pe=Tt(null,{useWorker:!0,resize:!0})),Pe}function O(h,c,g,M,A,E,U){var _=new Path2D(h),w=new Path2D;w.addPath(_,new DOMMatrix(c));var V=new Path2D;return V.addPath(w,new DOMMatrix([Math.cos(U)*A,Math.sin(U)*A,-Math.sin(U)*E,Math.cos(U)*E,g,M])),V}function X(h){if(!$)throw new Error("path confetti are not supported in this browser");var c,g;typeof h=="string"?c=h:(c=h.path,g=h.matrix);var M=new Path2D(c),A=document.createElement("canvas"),E=A.getContext("2d");if(!g){for(var U=1e3,_=U,w=U,V=0,ge=0,oe,xe,_e=0;_e<U;_e+=2)for(var J=0;J<U;J+=2)E.isPointInPath(M,_e,J,"nonzero")&&(_=Math.min(_,_e),w=Math.min(w,J),V=Math.max(V,_e),ge=Math.max(ge,J));oe=V-_,xe=ge-w;var He=10,et=Math.min(He/oe,He/xe);g=[et,0,0,et,-Math.round(oe/2+_)*et,-Math.round(xe/2+w)*et]}return{type:"path",path:c,matrix:g}}function re(h){var c,g=1,M="#000000",A='"Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji", "EmojiOne Color", "Android Emoji", "Twemoji Mozilla", "system emoji", sans-serif';typeof h=="string"?c=h:(c=h.text,g="scalar"in h?h.scalar:g,A="fontFamily"in h?h.fontFamily:A,M="color"in h?h.color:M);var E=10*g,U=""+E+"px "+A,_=new OffscreenCanvas(E,E),w=_.getContext("2d");w.font=U;var V=w.measureText(c),ge=Math.ceil(V.actualBoundingBoxRight+V.actualBoundingBoxLeft),oe=Math.ceil(V.actualBoundingBoxAscent+V.actualBoundingBoxDescent),xe=2,_e=V.actualBoundingBoxLeft+xe,J=V.actualBoundingBoxAscent+xe;ge+=xe+xe,oe+=xe+xe,_=new OffscreenCanvas(ge,oe),w=_.getContext("2d"),w.font=U,w.fillStyle=M,w.fillText(c,_e,J);var He=1/g;return{type:"bitmap",bitmap:_.transferToImageBitmap(),matrix:[He,0,0,He,-ge*He/2,-oe*He/2]}}D.exports=function(){return S().apply(this,arguments)},D.exports.reset=function(){S().reset()},D.exports.create=Tt,D.exports.shapeFromPath=X,D.exports.shapeFromText=re})((function(){return typeof window<"u"?window:typeof self<"u"?self:this||{}})(),Of,!1);const Xd=Of.exports;Of.exports.create;function q1(){const[z,R]=Ye.useState(!1),[D,m]=Ye.useState({name:"",email:"",message:""}),[Y,C]=Ye.useState(!1),[$,he]=Ye.useState(null),q=()=>{navigator.clipboard.writeText(fe.email),R(!0),Xd({particleCount:50,spread:60,origin:{y:.85},colors:["#0ea5e9","#6366f1","#10b981","#ffffff"]}),setTimeout(()=>R(!1),3e3)},N=async Z=>{Z.preventDefault(),C(!0),he(null);try{const G=await fetch(`https://formsubmit.co/ajax/${fe.email}`,{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify({name:D.name,email:D.email,message:D.message,_subject:`New Portfolio Message from ${D.name} (${D.email})`,_template:"table"})}),ue=await G.json();if(G.ok||ue.success==="true")he({success:!0,message:"Message dispatched successfully! I will reply to your email shortly."}),m({name:"",email:"",message:""}),Xd({particleCount:60,spread:70,origin:{y:.8},colors:["#0ea5e9","#6366f1","#10b981","#ffffff"]});else throw new Error(ue.message||"Failed to submit")}catch(G){console.error("Contact form error:",G);const ue=`mailto:${fe.email}?subject=Inquiry from ${encodeURIComponent(D.name)}&body=${encodeURIComponent(D.message+`

Sender Contact: `+D.email)}`;window.location.href=ue,he({success:!0,message:"Opening your default mail client..."})}finally{C(!1),setTimeout(()=>he(null),8e3)}};return s.jsxs("footer",{id:"contact",className:"contact-footer",children:[s.jsxs("div",{className:"container",children:[s.jsx("div",{className:"contact-card glass-panel",children:s.jsxs("div",{className:"contact-grid",children:[s.jsxs("div",{className:"contact-info",children:[s.jsx("span",{className:"section-tag",children:"Direct Communication"}),s.jsxs("h2",{className:"contact-title",children:["Let's Discuss Next ",s.jsx("br",{}),s.jsx("span",{className:"text-gradient",children:"Opportunities"})]}),s.jsxs("p",{className:"contact-desc",children:["I am actively seeking a ",s.jsx("strong",{children:"Full-stack / Frontend Software Engineer Internship"}),". Feel free to reach out via email, phone, or LinkedIn to discuss how I can contribute to your engineering team."]}),s.jsxs("div",{className:"info-pills-list",children:[s.jsxs("div",{className:"email-copy-box",children:[s.jsxs("div",{className:"email-text-wrap",children:[s.jsx(Wd,{size:16,color:"var(--accent-cyan)"}),s.jsx("span",{className:"email-text",children:fe.email})]}),s.jsx("button",{className:`copy-btn ${z?"copied":""}`,onClick:q,title:"Copy email to clipboard",children:z?s.jsxs(s.Fragment,{children:[s.jsx(Ld,{size:15,color:"var(--accent-emerald)"}),s.jsx("span",{children:"Copied!"})]}):s.jsxs(s.Fragment,{children:[s.jsx(k0,{size:15}),s.jsx("span",{children:"Copy Email"})]})})]}),s.jsxs("div",{className:"contact-meta-row",children:[s.jsxs("a",{href:`tel:${fe.phone}`,className:"meta-item-link",children:[s.jsx(Fd,{size:15,color:"var(--accent-emerald)"}),s.jsx("span",{children:fe.phone})]}),s.jsxs("div",{className:"meta-item",children:[s.jsx(Cf,{size:15,color:"var(--accent-indigo)"}),s.jsx("span",{children:fe.location})]})]})]}),s.jsxs("div",{className:"social-links-row",children:[s.jsxs("a",{href:fe.github,target:"_blank",rel:"noopener noreferrer",className:"social-btn",title:"GitHub Profile",children:[s.jsx(Df,{size:17}),s.jsx("span",{children:"GitHub"})]}),s.jsxs("a",{href:fe.linkedin,target:"_blank",rel:"noopener noreferrer",className:"social-btn",title:"LinkedIn Profile",children:[s.jsx(s1,{size:17}),s.jsx("span",{children:"LinkedIn"})]}),s.jsxs("a",{href:fe.cvUrl,target:"_blank",rel:"noopener noreferrer",className:"social-btn",title:"Download Resume PDF",children:[s.jsx(jf,{size:17}),s.jsx("span",{children:"Resume (PDF)"})]})]})]}),s.jsx("div",{className:"contact-form-wrap",children:s.jsxs("form",{onSubmit:N,className:"quick-form",children:[s.jsx("h3",{className:"form-title",children:"Send a Quick Message"}),s.jsxs("div",{className:"form-group",children:[s.jsx("label",{htmlFor:"form-name",children:"Your Full Name"}),s.jsx("input",{id:"form-name",type:"text",required:!0,placeholder:"e.g. John Doe / Tech Recruiter",value:D.name,onChange:Z=>m({...D,name:Z.target.value})})]}),s.jsxs("div",{className:"form-group",children:[s.jsx("label",{htmlFor:"form-email",children:"Your Email Address"}),s.jsx("input",{id:"form-email",type:"email",required:!0,placeholder:"name@company.com",value:D.email,onChange:Z=>m({...D,email:Z.target.value})})]}),s.jsxs("div",{className:"form-group",children:[s.jsx("label",{htmlFor:"form-msg",children:"Inquiry Details"}),s.jsx("textarea",{id:"form-msg",rows:"3",required:!0,placeholder:"Briefly describe the role, project, or collaboration...",value:D.message,onChange:Z=>m({...D,message:Z.target.value})})]}),s.jsxs("button",{type:"submit",className:"btn btn-primary form-submit-btn",disabled:Y,children:[s.jsx(x1,{size:15}),s.jsx("span",{children:Y?"Sending Message...":"Dispatch Message"})]}),$&&s.jsx("div",{style:{marginTop:"12px",padding:"10px 14px",borderRadius:"8px",fontSize:"13px",fontWeight:"500",backgroundColor:$.success?"rgba(16, 185, 129, 0.15)":"rgba(239, 68, 68, 0.15)",color:$.success?"#10b981":"#ef4444",border:`1px solid ${$.success?"#10b981":"#ef4444"}`},children:$.message})]})})]})}),s.jsxs("div",{className:"footer-bottom",children:[s.jsx("div",{className:"footer-left",children:s.jsxs("span",{className:"footer-copyright",children:["© ",new Date().getFullYear()," ",s.jsx("strong",{children:fe.name}),". Built with React 19 & Vite."]})}),s.jsxs("div",{className:"footer-badges",children:[s.jsxs("span",{className:"badge footer-badge",children:[s.jsx(Af,{size:11,color:"var(--accent-cyan)"}),"Verified CV Data"]}),s.jsxs("span",{className:"badge footer-badge",children:[s.jsx(Ld,{size:11,color:"var(--accent-emerald)"}),"CEFR B1 Standard"]})]})]})]}),s.jsx("style",{children:`
        .contact-footer {
          padding: 70px 0 36px;
          position: relative;
        }
